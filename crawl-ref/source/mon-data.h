...
{ // a dummy monster for recolouring
    MONS_FELOID, 'h', MAGENTA, "feloid",
    M_SEE_INVIS | M_WARM_BLOOD | M_SPEAKS | M_NO_POLY_TO,
    MR_NO_FLAGS,
    10, MONS_FELOID, MONS_FELOID, MH_NATURAL, 40,
    ...
    {TILEP_MONS_FELOID}, TILE_CORPSE_FELID
},
...
// "h" - carnivorous quadrupeds
{
    ...
    MR_NO_FLAGS,
    10, MONS_FELOID, MONS_FELOID, MH_NATURAL | MH_EVIL, 20,
    { {AT_CLAW, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 150,
